...
const { getListManager, getSixMonthInputAndOuput,
    getListShop, editShop, addShop, addManager, editManager, deleteManager, getSixMonthInputAndOuputAllShop,
    getListIngredient, addIngredient, editIngredient, getListRecipeAdmin, detailRecipeAdmin, addRecipe,
    editRecipe, editRecipeIngredient, getListType, addRecipeType, deleteRecipeType }
    = require("../controllers/admin.controllers");
const { checkNotExistAcount, checkExistAccount, checkNotExistShopWithLatitudeAndLongitude, checkExistIngredient, checkExistIngredientAndRecipe, checkExistTypeAndRecipe } = require("../middlewares/validates/checkExist");
...
adminRouter.put("/editRecipeIngredient", authenticate, authorize(3), checkExistIngredientAndRecipe(), editRecipeIngredient)
...
adminRouter.get("/getListType", getListType)
