...
const { getToppingOptions, addToCart, getCurrentCart,
        ...
        getAllInvoiceByDate, searchRecipe, testInvoice  } = require("../controllers/order.controllers");
...
orderRouter.post("/createInvoice",authenticate, authorize(0),checkExistCurrentCart(),checkExistInvoiceLessThan3(),createInvoice)
orderRouter.post("/testInvoice",authenticate, authorize(0),checkExistCurrentCart(),checkExistInvoiceLessThan3(),testInvoice)
